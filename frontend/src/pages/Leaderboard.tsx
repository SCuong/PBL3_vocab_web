    ...
    return (
        <div className="max-w-4xl mx-auto px-6 py-12">
            ...
            <div className="podium items-end mb-16 flex justify-center gap-4">
                ...
                {top3.length > 0 && (
                    <div className="flex flex-col items-center">
                        <div className="w-24 h-24 rounded-full border-4 border-accent p-1 mb-4 shadow-xl scale-110"><div className="w-full h-full rounded-full bg-linear-to-br from-accent to-secondary flex items-center justify-center text-[2rem]">{top3[0].avatar}</div></div>
            ...
            <div className="glass-card divide-y divide-purple/10">
                {leaderboard.map((u: any, i: number) => (
                    <div key={u.id} className="flex items-center gap-6 p-6 hover:bg-purple/5 transition-colors">
                        ...
                        <div className="w-12 h-12 rounded-full bg-surface flex items-center justify-center text-2xl shadow-sm border border-primary/10">{u.avatar}</div>
