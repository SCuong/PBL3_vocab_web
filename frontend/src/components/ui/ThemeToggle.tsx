...
export const ThemeToggle = ({ className = '' }: ThemeToggleProps) => {
    ...
    const hasPositionOverride = /\b(static|fixed|absolute|sticky)\b/.test(className);
    ...
    return (
        <button
            ...
            aria-pressed={isDark}
            className={`${positionClass} inline-flex h-9 w-16 shrink-0 cursor-pointer items-center rounded-full border px-1 shadow-inner transition-colors duration-300 hover:border-primary/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 focus-visible:ring-offset-2 focus-visible:ring-offset-bg-primary ${
